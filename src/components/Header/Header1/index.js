      ...
      <header className={props.className}>
        <Row className="bg-indigo_901 items-center lg:p-[12px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[20px] w-[100%]">
          <Row className="items-start lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[92%]">
            <Text
              className="cursor-pointer hover:font-normal font-ptsans lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] text-white_A700_99 w-[auto]"
              as="h1"
              variant="h1"
            >
            ...
            />
            <Text
              className="cursor-pointer hover:font-normal font-normal font-ptsans lg:ml-[36px] xl:ml-[45px] 2xl:ml-[51px] 3xl:ml-[61px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] not-italic text-white_A700 hover:text-white_A700_99 w-[auto]"
              variant="body1"
            >
              Help
            </Text>
            <Stack className="bg-amber_600 border border-solid border-white_A700 ml-[4px] rounded-radius50 Multiply">
              <Img
