        ...
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="items-center justify-start w-[100%]">
            <Row className="items-center justify-evenly w-[100%]">
              ...
              <Button
                className="font-normal not-italic lg:text-[11px] xl:mt-[0px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[19%]"
                size="xl"
              >
                Review and complete
              </Button>
              ...
              <Column className="items-center justify-start w-[68%]">
                ...
                <Column className="items-center justify-start lg:mt-[33px] xl:mt-[41px] 2xl:mt-[47px] 3xl:mt-[56px] w-[99%]">
                  ...
                  <Row className="items-center justify-between lg:mt-[41px] xl:mt-[51px] 2xl:mt-[58px] 3xl:mt-[69px] w-[100%]">
                    <Stack 
                    className="bg-white_A700 hover:bg-gray_50 lg:h-[35px] xl:h-[44px] 2xl:h-[50px] 3xl:h-[59px] outline outline-[1px] outline-light_blue_500 xl:px-[12px] 2xl:px-[14px] 3xl:px-[16px] lg:px-[9px] shadow-bs w-[13%]"
                    onClick={handleNavigate110}
                    >
                      <Img
                        src="images/img_arrowleft_30X31.svg"
                        className="common-pointer ExpandArrow"
                        alt="ExpandArrow"
