      ...
      <Column className="bg-gray_100 font-ptsans justify-start mx-[auto] lg:pb-[118px] xl:pb-[147px] 2xl:pb-[166px] 3xl:pb-[199px] w-[100%]">
        <Column className="items-center w-[100%]">
          <Stack className="2xl:h-[102px] 3xl:h-[122px] lg:h-[72px] xl:h-[90px] w-[100%]">
            ...
            <Row className="absolute bg-indigo_901 items-center lg:p-[18px] xl:p-[23px] 2xl:p-[26px] 3xl:p-[31px] w-[100%]">
              <Row className="items-start lg:ml-[5px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] mt-[2px] w-[94%]">
                <Text
                  className="lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] text-white_A700 w-[auto]"
                  as="h3"
                  variant="h3"
                >
                  HalalHoliday
          ...
          <Stack className="font-ptsanscaption lg:h-[45px] xl:h-[56px] 2xl:h-[63px] 3xl:h-[75px] mt-[1px] w-[100%]">
              ...
              <Column className="items-center justify-start w-[100%]">
                <Row className="items-start w-[47%]">
                  <Column className="items-center justify-start mt-[2px] w-[33%]">
                    <Column className="items-center justify-start w-[100%]">
                      <Text
                        className="font-normal text-gray_500 w-[auto]"
                        variant="body4"
                      >
                        Property setup
                      </Text>
                  ...
                  <Text
                    className="font-normal 3xl:ml-[106px] lg:ml-[63px] xl:ml-[79px] 2xl:ml-[89px] text-gray_500 w-[auto]"
                    variant="body4"
                  >
                    Photos
                  </Text>
                  <Text
                    className="lg:ml-[103px] xl:ml-[129px] 2xl:ml-[146px] 3xl:ml-[175px] columndoublebed"
                    variant="body4"
                  >
            ...
            <Row className="absolute font-ptsans h-[max-content] inset-y-[0] items-end justify-center left-[3%] my-[auto] xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] lg:p-[9px] w-[22%]">
              <Text
                className="font-normal mb-[4px] lg:ml-[46px] xl:ml-[57px] 2xl:ml-[65px] 3xl:ml-[78px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] not-italic text-gray_500 w-[auto]"
                variant="body2"
              >
                Name and location
              </Text>
              <Img
                ...
                className="lg:h-[18px] xl:h-[23px] 2xl:h-[26px] 3xl:h-[31px] lg:mb-[4px] xl:mb-[6px] 2xl:mb-[7px] 3xl:mb-[8px] lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mr-[29px] xl:mr-[37px] 2xl:mr-[42px] 3xl:mr-[50px] lg:w-[17px] xl:w-[22px] 2xl:w-[25px] 3xl:w-[30px]"
                alt="checkmark"
              />
            </Row>
          </Stack>
        ...
        <Column className="font-ptsanscaption items-center justify-start xl:ml-[118px] 2xl:ml-[133px] 3xl:ml-[159px] lg:ml-[94px] lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] w-[40%]">
          <Column className="justify-start w-[100%]">
            ...
            <Stack className="lg:h-[348px] xl:h-[435px] 2xl:h-[489px] 3xl:h-[586px] ml-[3px] lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[99%]">
              <Column className="absolute bg-white_A700 justify-start left-[0] lg:py-[20px] xl:py-[25px] 2xl:py-[29px] 3xl:py-[34px] shadow-bs4 w-[100%]">
                ...
                <Column className="justify-start lg:mb-[18px] xl:mb-[23px] 2xl:mb-[26px] 3xl:mb-[31px] 3xl:mt-[117px] lg:mt-[69px] xl:mt-[87px] 2xl:mt-[98px] w-[100%]">
                  ...
                  >
                    ...
                    <Row className="bg-white_A700 items-start lg:my-[25px] xl:my-[32px] 2xl:my-[36px] 3xl:my-[43px] lg:pt-[10px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] lg:px-[10px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] w-[100%]">
                      <Img
                        ...
                        className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] mt-[2px] lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]"
                        alt="car One"
                      />
                  ...
                  <Row className="font-ptsans items-start lg:ml-[19px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] lg:mt-[32px] xl:mt-[40px] 2xl:mt-[45px] 3xl:mt-[54px] w-[21%]">
                    <Img
                      ...
                      className="xl:h-[11px] 2xl:h-[13px] 3xl:h-[15px] lg:h-[9px] w-[5%]"
                      alt="arrowright"
                    />
              ...
              <Column className="absolute bg-white_A700 inset-x-[0] items-center justify-end xl:p-[12px] 2xl:p-[14px] 3xl:p-[16px] lg:p-[9px] top-[15%] w-[100%]">
                <Row className="items-start mt-[1px] w-[95%]">
                  <Img
                    src="images/img_bag.svg"
                    className="lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] mt-[2px] lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]"
                    alt="bag"
                  />
