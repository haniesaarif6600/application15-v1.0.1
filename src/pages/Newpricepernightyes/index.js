          ...
          <Column className="items-center justify-start mt-[1px] w-[100%]">
            <Stack className="3xl:h-[104px] lg:h-[62px] xl:h-[77px] 2xl:h-[87px] w-[100%]">
              ...
              <Column className="absolute bg-gray_50 items-center justify-end py-[1px] right-[22%] shadow-bs w-[19%]">
                <Column className="items-center justify-start lg:mt-[26px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[100%]">
                        ...
                        <Row className="items-center 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] w-[21%]">
                          <Stack className="lg:h-[21px] xl:h-[26px] 2xl:h-[30px] 3xl:h-[35px] w-[46%]">
                            <Img
                              ...
                              className="common-pointer absolute lg:h-[21px] xl:h-[26px] 2xl:h-[30px] 3xl:h-[35px] left-[0] w-[64%]"
                              alt="Record"
