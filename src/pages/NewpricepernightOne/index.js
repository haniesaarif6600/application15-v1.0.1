...
const NewpricepernightOnePage = () => {
  const navigate = useNavigate();

  function handleNavigate35() {
    navigate("/newpricepernightyesone");
  }
  function handleNavigate36() {
    navigate("/newpricepernightnoone");
  }
            ...
            <Row className="items-start lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] w-[86%]">
              <Column className="justify-start w-[76%]">
                <Row className="items-end justify-between w-[100%]">
                  <Stack className="lg:h-[192px] xl:h-[240px] 2xl:h-[270px] 3xl:h-[323px] w-[64%]">
                    <Column className="absolute bg-white_A700 bottom-[0] items-center justify-start lg:p-[10px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] w-[100%]">
                    ...
                    <Text
                      className="absolute left-[0] top-[0] Firstlastname"
                      as="h6"
                      variant="h6"
                    >
                      Price per night
                    ...
                    <Column className="absolute justify-start w-[100%]">
                      ...
                      <Column className="bg-white_A700 items-center justify-start lg:mt-[24px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[40px] lg:p-[10px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] w-[100%]">
                        <Column className="justify-start 2xl:my-[11px] 3xl:my-[13px] lg:my-[7px] xl:my-[9px] w-[99%]">
                          <Text
                            className="columndescription_two"
                            variant="body3"
                          >
                            <span className="text-black_900 font-ptsans lg:text-[12px] xl:text-[15px] 2xl:text-[17px] 3xl:text-[20px]">
                              Properties that received bookings over the last
                              year and share similar features such as location,
                              facilities, and amenities to yours have usually
                              had pricing that falls between
                            </span>
                            <span className="text-black_900 font-ptsans font-bold lg:text-[12px] xl:text-[15px] 2xl:text-[17px] 3xl:text-[20px]">
                              {" "}
                              MYR 89.02 - MYR 146.14
                  ...
                  <Stack className="bg-white_A700 lg:h-[152px] xl:h-[190px] 2xl:h-[214px] 3xl:h-[256px] lg:mt-[39px] xl:mt-[49px] 2xl:mt-[56px] 3xl:mt-[67px] w-[31%]">
                ...
                <Column className="bg-white_A700 items-center justify-start ml-[3px] lg:mt-[24px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[40px] 2xl:p-[11px] 3xl:p-[13px] lg:p-[7px] xl:p-[9px] w-[64%]">
                  ...
                  <Column className="items-center justify-start lg:mb-[12px] xl:mb-[15px] 2xl:mb-[17px] 3xl:mb-[20px] lg:mt-[24px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[99%]">
                ...
                <Column className="items-center justify-start lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] lg:mt-[24px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[64%]">
                  <Column className="items-center justify-start w-[100%]">
                    <Line className="bg-bluegray_100 h-[1px] w-[100%]" />
              ...
              <Stack className="bg-blue_50 lg:h-[136px] xl:h-[170px] 2xl:h-[192px] 3xl:h-[230px] lg:ml-[4px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[152px] xl:mt-[191px] 2xl:mt-[215px] 3xl:mt-[258px] shadow-bs w-[24%]">
...
export default NewpricepernightOnePage;
